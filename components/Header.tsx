...
export const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    ...
    >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#151515] border-b border-neutral-800 px-6 py-5 shadow-2xl">
          <div className="flex flex-col gap-4 text-sm font-bold tracking-wider">
            ...
            {navItems.map((item) => (
              <a
                ...
                href={item.href}
                onClick={(e) => handleNavClick(e, item.href)}
                className="py-2 text-neutral-300 hover:text-[#D32F2F] border-b border-neutral-800 flex items-center justify-between"
              >
            ...
            <div className="pt-2 flex flex-col gap-2">
              ...
              >
                ...
                <span>
                  LLAMAR PARA RESERVAR ({RESTAURANT_INFO.phone})
                </span>
              </a>
